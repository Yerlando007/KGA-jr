module.exports = {
	...
	initialMessage: `**Нажмите на реакцию, чтобы выбрать ваш ауыл и получите прописку! Вы можете отменить свой выбор снова нажав на реакцию!**`,
	
	embedMessage: `
      
	Нажмите на реакцию, чтобы выбрать ваш ауыл и получите прописку!
	...
	roles: ["РОЗОВЫЕ", "ГОЛУБЫЕ", "КОРИЧНЕВЫЕ", "САМЫЕ ГОЛУБЫЕ"],
